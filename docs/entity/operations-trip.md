...
### Query: Display distance

Purpose

: Give the user the information obtained about their distance traveled for a given day. 
...
: Allow the user to display their start and end time for a given day, counting that session as a day ridden for the day tracker.
